...
class ResponceComicSJ: AnyStoryResponseProtocol {
    var code: Int?
    var status: String?
...
class DataComicSJ: AnyStoryDataProtocol {
    var offset: Int?
    var limit: Int?
    var total: Int?
    var count: Int?
    ...
    convenience init(from json: JSON) {
        ...
        self.results = resultsJSONs.map { ComicsSJ (from: $0) }
    }
}


class ComicsSJ: Object, AnyStoryProtocol {
